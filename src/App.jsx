        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-gradient-to-br from-blue-600 to-orange-400 rounded-full flex items-center justify-center">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <a href="#catalogo" className="text-gray-700 hover:text-blue-600 transition-colors">Catálogo</a>
